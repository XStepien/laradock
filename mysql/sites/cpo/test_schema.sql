...
MySQL - 5.7.11 : Database - cpo_test
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cpo_test` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `cpo_test`;

/*Table structure for table `cpo_messages` */

DROP TABLE IF EXISTS `cpo_messages`;

CREATE TABLE `cpo_messages` (
  `pid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `batchId` varchar(48) DEFAULT NULL,
